...
% \usepackage{caption,kantlipsum,setspace}
...
\thesissubtitle{\bf The importance of ice microphysics in storm electrification}        
\author{Yichen Cai}        
...
\tableofcontents
\addtocontents{toc}{\protect\thispagestyle{empty}} % remove 1st toc pagenumber
\thispagestyle{empty} % remove last toc pagenumber
\clearpage % start page number from next page
\pagenumbering{arabic} % reset page number to start from 1
